...
## Research Question
**"How can I create a playful, gesture-based interactive installation that evokes wonder, openness, growth, and vulnearbility through physical-digital systems ?"**

## Electrical Components
- Ultrasonic Sensor
- Servo Motor 
- Breadboad 
- Power Module with Battery (Exhibition: Refurbished old iMac as Power Supply w/ Voltage Reducer Regulator)
